    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <span class="navbar-brand">
                <img src="assets/img/logo-removebg-preview (1).png" alt="Logo de l'entreprise">
            </span>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">DAIA TECHNOLOGIE</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Entreprise spécialisée en conseil de stratégie média, accompagnement digital, et production audiovisuelle
                    </p>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">À Propos de DAIA Technologie
                    </h2>
                    <hr class="divider divider-light" />
                    <p class="text-white-75 mb-4">DAIA Technologie est une entreprise spécialisée dans l'accompagnement digital et le conseil de stratégie média. Nous aidons nos clients à réussir leur transformation digitale.</p>
